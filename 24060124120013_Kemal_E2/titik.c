...
{
    return getAbsis(T) == 0 && getOrdinat(T) == 0 ? true : false;
}
...
{
    return getOrdinat(T) == 0 ? true : false;
}
...
{
    return getAbsis(T) == 0 ? true : false;
}
...
{
    return getAbsis(T1) == getAbsis(T2) && getOrdinat(T1) == getOrdinat(T2) ? true : false;
}
